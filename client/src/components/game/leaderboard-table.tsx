          ...
          <tbody>
            {rows.map((row) => {
              ...
              return (
                ...
                >
                  <td className="px-4 py-3 font-black text-[#cf1a4f]">{row.position}</td>
                  <td className="px-4 py-3 font-bold">{row.nickname}</td>
                  <td className="px-4 py-3 font-black text-[#ff7a00]">{row.score}</td>
                  <td className="px-4 py-3">{accuracy}%</td>
                  <td className="px-4 py-3 text-base-ink/70">{formatDate(row.playedAt)}</td>
                </tr>
              );
            })}
          </tbody>
